...
5.times do |i|
  User.create(email: Faker::Internet.email, password: Faker::Internet.password, philosopher: true, username: Faker::Internet.username, image_url: Faker::Avatar.image, credit_card: Faker::Finance.credit_card)
end
5.times do |i|
  User.create(email: Faker::Internet.email, password: Faker::Internet.password, philosopher: false, username: Faker::Internet.username, image_url: Faker::Avatar.image, credit_card: Faker::Finance.credit_card)
end
